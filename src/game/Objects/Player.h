...
class Player final: public Unit
{
    ...
    public:
        ...
        void SendLoot(ObjectGuid guid, LootType loot_type, Player const* pVictim = nullptr);
    ...
    public:
        ...
        void RewardPlayerAndGroupAtEvent(uint32 creature_id, WorldObject const* pRewardSource);
